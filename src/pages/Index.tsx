    ...
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-white">
      ...
      <div className="relative h-[600px] bg-[url('https://images.unsplash.com/photo-1487958449943-2429e8be8625')] bg-cover bg-center">
        ...
        <div className="relative z-10 flex h-full items-center justify-center text-center">
          <div className="px-4">
            <h1 className="mb-6 text-5xl font-bold text-yellow-300 md:text-6xl">Triangle Country Club</h1>
            <p className="mb-8 text-xl text-yellow-100">Where Luxury Meets Nature</p>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16">
        <h2 className="mb-12 text-center text-3xl font-bold text-yellow-900">Experience Excellence</h2>
